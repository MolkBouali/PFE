...
class AvisView(QWidget):
    ...
    def _build_ui(self):
        ...
        self.chk_der = QCheckBox("DER -- Direction Exploitation et Reglementation")
        self.chk_dta = QCheckBox("DTA -- Direction Technique et Aeroportuaire")
        self.chk_dana = QCheckBox("DANA -- Direction Aeronavigabilite")
        self.chk_dna = QCheckBox("DNA -- Direction Navigation Aerienne")
